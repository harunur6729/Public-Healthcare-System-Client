...
const ManageDoctors = () => {
    ...
    const { data: doctors, isLoading, refetch } = useQuery({
        ...
        queryFn: async () => {
            try {
                const res = await fetch('https://public-healthcare-system-server.vercel.app/doctors', {
                    headers: {
    ...
    const handleDeleteDoctor = doctor => {
        fetch(`https://public-healthcare-system-server.vercel.app/doctors/${doctor._id}`, {
            method: 'DELETE',
            headers: {
                authorization: `bearer ${localStorage.getItem('accessToken')}`
            }
